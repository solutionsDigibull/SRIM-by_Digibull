...
import { LocalLlmAdvisor } from './LocalLlmAdvisor';
import { LocalModelQuickStart } from './LocalModelQuickStart';
...
export function ProviderGrid({
  ...
  return (
    <div className="rounded-xl border border-border bg-provider-bg p-4" data-testid="provider-grid">
      {/* LOCAL LLM advisor — machine specs + recommended local models */}
      <LocalLlmAdvisor />
      <LocalModelQuickStart onOpenProvider={onSelectProvider} />
